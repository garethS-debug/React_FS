...
export default function UsePresenceData() {
    ...
    const color = `var(--hue-${selectedItem}, ${box.backgroundColor})`
    ...
    return (
        <div style={container}>
            ...
            <AnimatePresence initial={false} mode="popLayout">
                <Slide key={selectedItem} color={color} direction={direction} item={selectedItem} />
            </AnimatePresence>
            <motion.button
                initial={false}
                animate={{ backgroundColor: color }}
...
const Slide = forwardRef(function Slide(props, ref) {
    const { color, direction, item } = props
    return (
        <motion.div
            ref={ref}
